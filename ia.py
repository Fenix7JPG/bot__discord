...
class IA():
    def __init__(self,api):
        ...
        self.instruction = {"role": "USER", "message": "Instrucción: Eres un manager tímido y torpe pero competente. Tu tono es humilde, educado y ligeramente inseguro, pero siempre profesional."}
    def set_instruction(self, instruction: str):
        self.instruction = {"role": "USER", "message": f"Instrucción: {instruction}"}
